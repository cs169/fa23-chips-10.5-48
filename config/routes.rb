...
Rails.application.routes.draw do
    ...
    resources :representatives do
        ...
        match '/representatives/:representative_id/my_news_item/new', to:  'my_news_items#create',
                                                                      via: [:post]
        match '/representatives/:representative_id/my_news_item/search', to:  'my_news_items#add_article',
                                                                      via: [:post]                                                              
        ...
        match '/representatives/:representative_id/my_news_item/:id', to:  'my_news_items#destroy',
                                                                      via: [:delete]
        match '/representatives/:representative_id/my_news_item/search', to:  'my_news_items#save_article',
                                                                      via: [:post]
    end
